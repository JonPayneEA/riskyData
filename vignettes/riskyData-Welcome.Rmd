...
```{r dayBodge, echo = FALSE}
data(bewdley)

c <- bewdley$clone()
c$data <- c$data[dateTime >= '2022-06-11 00:00' & dateTime <= '2022-06-12 00:00',]

with(c$data, plot(dateTime, value, type = 'l', xlab = "Date Time", ylab = "Flow (cumecs)"))
```
...
```{r rangeBodge, echo = FALSE}
data(bewdley)

d <- bewdley$clone()
d$data <- d$data[dateTime >= '2019-10-01 00:00' & dateTime <= '2020-03-30 00:00',]

with(d$data, plot(dateTime, value, type = 'l', xlab = "Date Time", ylab = "Flow (cumecs)"))
```
